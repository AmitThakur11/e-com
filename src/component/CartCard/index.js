...
<img
    src={productId.img}
    alt="women-pink-t-shirt-back"
    border="0"
  />
  <div className="x-cart-content">
  <div className="x-cart-title">
      {productId.name}
      </div>
    ...
    <button className="x-cart-btn" onClick={() => moveToWishlist(productId._id , userDispatch, setLoading)}>Move to wishist</button>
    </div>
    </div>
    </section>
